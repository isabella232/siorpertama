...
<body>
<p></p>
<img src="http://i1010.photobucket.com/albums/af230/ntonk59/Untitled-1.png" width="665" height="215" />
<div id="apDiv2">
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="572" border="0">
    <tr>
      <td width="108">ID Warga </td>
      <td width="18">:</td>
      <td width="431"><input type="text" name="textfield" /></td>
    </tr>
    <tr>
      <td>ID Rumah </td>
      <td>:</td>
  ...
  <table width="572" border="0">
    <tr>
      ...
      <td width="18">:</td>
      <td width="75"><select name="select">
      ...
      <td width="122"><select name="select2">
      ...
      <td width="227"><select name="select4">
        <option>2008</option>
        <option>2009</option>
        <option>2010</option>
        <option>2011</option>
