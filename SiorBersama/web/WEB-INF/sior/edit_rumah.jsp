...
<div id="apDiv1">
  <table width="678" height="258">
    <tr>
      <td width="17%">Kode Rumah </td>
      <td width="83%"><input type="text" name="kode_keluarga" value="<%=keluarga.getKodekeluarga().substring(0)%> style="width:="width:" 160px></td>
    </tr>
    <tr>
      <td >Alamat Rumah </td>
...
<div id="apDiv2">
  <p><span style="margin: 10px;">
    ...
    <input type="submit" name="Submit2" value="Hapus" />
    <a href="javascript:document.form_tambah_keluarga.reset()">
    <input type="button" name="button" value="Simpan" />
    </a>
