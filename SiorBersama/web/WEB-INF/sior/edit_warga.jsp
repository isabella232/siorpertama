...
<div id="apDiv1">
  <table width="679" height="299">
    <tr>
      <td width="27%">No.KTP</td>
      <td width="57%"><input type="text" name="kode_keluarga" value="<%=keluarga.getKodekeluarga().substring(0)%> style="width:="width:" 160px></td>
    </tr>
    <tr>
      <td >Nama Lengkap </td>
