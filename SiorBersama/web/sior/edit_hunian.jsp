...
<div id="apDiv1">
  <table width="678" height="237">
    <tr>
      <td width="15%">Kode Hunian </td>
      <td width="85%"><input type="text" name="kode_keluarga" value="<%=keluarga.getKodekeluarga().substring(0)%> style="width:="width:" 160px></td>
    </tr>
    <tr>
      <td >Kode Rumah </td>
