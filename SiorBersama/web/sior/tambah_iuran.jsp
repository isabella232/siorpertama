...
<div id="apDiv1">
  <table width="676" height="185">
    <tr>
      <td width="30%">Kode Iuran </td>
      <td width="60%"><input type="text" name="kode_keluarga" style="width: 160px" /></td>
    </tr>
    <tr>
      <td >Tanggal Iuran </td>
      <td><input type="text" name="kepala_keluarga" style="width: 160px" /></td>
    </tr>
    <tr>
      <td>Nama Pembayar </td>
      <td><input type="text" name="almtDonatur" style="width: 160px" /></td>
    </tr>
    <tr>
      <td>Jenis Iuran </td>
      <td><input type="text" name="almtDonatur" style="width: 160px" /></td>
...
<div id="templatemo_banner">
  ...
  <div id="example">
    ...
    <div id="templatemo_content">
        ...
        <h2>User</h2>
	          <div class="left_col_box">
	            <form method="get" action="#">
	              <p>Hi, User</p>
	              <p>
                  <!-- #BeginDate format:fcAm1a -->Tuesday, January 3, 2012 11:22 AM<!-- #EndDate --></p>
	              <p>
      ...
      <h3>Keuangan &gt;&gt; Iuran &gt;&gt; Tambah Iuran</h3>
</div>
