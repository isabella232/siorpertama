...
<div id="apDiv1">
  <table width="680" height="278">
    <tr>
      <td width="29%" height="36">No.KTP</td>
      <td width="36%">Nama Lengkap </td>
      <td width="36%">Tempat Lahir </td>
      <td width="36%">Alamat KTP </td>
      <td width="36%">Kota KTP </td>
    </tr>
    <tr>
        ...
        <h2>User</h2>
	          <div class="left_col_box">
	            <form method="get" action="#">
	              <p>Hi, User</p>
	              <p>
                  <!-- #BeginDate format:fcAm1a -->Wednesday, January 4, 2012 10:20 PM<!-- #EndDate --></p>
	              <p>
