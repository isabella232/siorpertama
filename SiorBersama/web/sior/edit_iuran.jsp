...
<div id="apDiv1">
  <table width="677" height="212">
    <tr>
      <td width="14%">Kode Iuran </td>
      <td width="86%"><input type="text" name="kode_keluarga" value="<%=keluarga.getKodekeluarga().substring(0)%> style="width:="width:" 160px></td>
    </tr>
    <tr>
      <td >Tanggal Iuran </td>
