...
<div id="apDiv1">
  ...
  <table width="507" border="0">
    <tr>
      ...
      <td width="7">:</td>
      <td width="358"><input name="rt_rumah" type="text" size="8" /></td>
    </tr>
    <tr>
      <td>Nama Lengkap</td>
      <td>:</td>
    ...
    <tr>
      <td>Tanggal Lahir</td>
      <td>:</td>
      <td><input name="kota_rumah5" type="text" size="30" /></td>
    </tr>
    <tr>
      <td>Alamat KTP</td>
      <td>:</td>
      <td><textarea name="alamat_area2" cols="50" rows="4"></textarea></td>
    </tr>
    <tr>
      <td>RT</td>
      <td>:</td>
    ...
    <tr>
      <td>RW</td>
      <td>:</td>
      <td><input name="kota_rumah2" type="text" size="30" /></td>
    </tr>
    <tr>
      <td>Kelurahan</td>
      <td>:</td>
      <td><input name="kota_rumah3" type="text" size="30" /></td>
    </tr>
    <tr>
      <td>Kecamatan</td>
      <td>:</td>
      <td><input name="kota_rumah4" type="text" size="30" /></td>
    </tr>
    <tr>
      <td>Kota KTP</td>
      <td>:</td>
        ...
        <h2>User</h2>
	          <div class="left_col_box">
	            <form method="get" action="#">
	              <p>Hi, User</p>
	              <p>
	                <!-- #BeginDate format:fcAm1a -->Wednesday, January 4, 2012 10:18 PM<!-- #EndDate -->
                  </p>
	              <p>
