...
<div id="apDiv1">
  <table width="678" height="80" id="rounded-corner">
    <thead>
      <tr>
        <th width="66" class="rounded-company" scope="col">Kode Bayar</th>
        <th width="57" class="rounded-q1" scope="col">Pekerja</th>
        <th width="55" class="rounded-q2" scope="col">Jenis</th>
        <th width="65" class="rounded-q3" scope="col">Bulan Gaji</th>
        <th width="57" class="rounded-q4" scope="col">Tahun Gaji</th>
        <th width="42" class="rounded-q5" scope="col">Cek</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><%=gaji.getBulangaji()%></td>
        <td><%=keluargaindo.getAnggotakel()%></td>
        <td><%=gaji.getTahungaji()%></td>
        <td width="136"><input  type="checkbox"  name="cek_gaji" value="<%=gaji.getIdgaji()%>" /></td>
        <td width="164"><a href="edit_gaji">
          <input name="butto42" type="button" value="edit"/>
        </a></td>
      </tr>
      <%}%>
    </tbody>
...
<div id="templatemo_banner">
  ...
  <div id="example">
    ...
    <div id="templatemo_content">
        ...
        <h2>User</h2>
	          <div class="left_col_box">
	            <form method="get" action="#">
	              <p>Hi, User</p>
	              <p>
                  <!-- #BeginDate format:fcAm1a -->Tuesday, January 3, 2012 11:16 AM<!-- #EndDate --></p>
	              <p>
      ...
      <h3>Keuangan &gt;&gt; Gaji &gt;&gt; Daftar Gaji</h3>
<p>&nbsp;</p>
    </div>
