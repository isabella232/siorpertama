...
<div id="apDiv1">
  <table width="679" height="236">
    <tr>
      <td width="16%">Kode Rumah </td>
      <td width="14%">Alamat Rumah </td>
      <td width="17%">Kelurahan Rumah </td>
      <td width="17%">Kecamatan Rumah </td>
    </tr>
    <tr>
      <td width="16%">&nbsp;</td>
      <td >&nbsp;</td>
...
<div id="templatemo_banner">
  ...
  <div id="example">
    ...
    <div id="templatemo_content">
        ...
        <h2>User</h2>
	          <div class="left_col_box">
	            <form method="get" action="#">
	              <p>Hi, User</p>
	              <p>
                  <!-- #BeginDate format:fcAm1a -->Tuesday, January 3, 2012 11:15 AM<!-- #EndDate --></p>
	              <p>
      ...
      <h3>Hunian &gt;&gt; Rumah &gt;&gt; Daftar Rumah</h3>
<p>&nbsp;</p>
    </div>
