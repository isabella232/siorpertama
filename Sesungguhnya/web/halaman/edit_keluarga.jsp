...
<body>
<div id="apDiv3">
  <table width="667" height="140">
    <tr>
      <td width="20%">Kode Keluarga</td>
      <td width="80%"><input type="text" name="kode_keluarga" value="<%=keluarga.getKodekeluarga().substring(0)%> style="width:="width:" 160px></td>
    </tr>
    <tr>
...
<div id="templatemo_banner">
  <div id="apDiv"><img src="banner sior copy.png" alt="" width="549" height="180" /></div>
</div>
  <div id="example">
    ...
    <div id="templatemo_content">
      ...
      <h3>Warga &gt;&gt; Keluarga &gt;&gt; Edit Keluarga</h3>
      <p>&nbsp;</p>
<p>&nbsp;</p>
    </div>
