 ...
 * @author ACER
 */
@WebServlet(name = "HalamanHunian", urlPatterns = {"/HalamanEditHunian"})
public class HalamanEditHunian extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Hunian hunian=daf.getHunian(idHun);
        
        HttpSession sessionedit=request.getSession();
        sessionedit.setAttribute("hunian", hunian);
