 ...
 * @author ntonk
 */
@WebServlet(name = "HalamanEditGaji", urlPatterns = {"/HalamanEditGaji"})
public class HalamanEditGaji extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idGaji= request.getParameter("idGaji");
        
        DaftarGaji daf=new DaftarGaji();
        Gaji gaji=daf.getGaji(idGaji);
        
        HttpSession sessionedit=request.getSession();
        sessionedit.setAttribute("gaji", gaji);
        request.setAttribute("gaji", gaji);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HalamanEditGaji</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HalamanEditGaji at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
