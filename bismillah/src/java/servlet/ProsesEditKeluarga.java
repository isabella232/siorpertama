 ...
 * @author ACER
 */
@WebServlet(name = "ProsesEditKeluarga", urlPatterns = {"/ProsesEditKeluarga"})
public class ProsesEditKeluarga extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Long id = Long.parseLong(request.getParameter("idKel"));
        
        DaftarKeluarga daftar = new DaftarKeluarga();
        Keluarga keluarga = (Keluarga)sessionedit.getAttribute("keluarga");
